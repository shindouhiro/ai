...
export default function ChatPage() {
  ...
  return (
    <main suppressHydrationWarning className="relative min-h-screen flex bg-white dark:bg-[#0a0a0a] text-black dark:text-white transition-colors duration-300 overflow-hidden">
      ...
      {/* 主聊天区域 */}
      <div className={cn(
        "flex-1 flex flex-col items-center justify-center p-0 md:p-4 transition-all duration-500",
        isSidebarOpen && session ? "md:ml-[280px]" : "ml-0"
      )}>
        {/* 炫酷背景渐变 */}
