...
import { User, Mail, Lock, AlertCircle, LogIn, LayoutGrid } from "lucide-react";
      ...
      <form action={action} className="flex flex-col gap-5">
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative group">
            <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-black/30 dark:text-white/30 group-focus-within:text-violet-500 transition-colors" />
            <input
              name="name"
              type="text"
              placeholder="您的称呼"
        ...
        >
          {isPending ? (
            ...
            <>
              快速注册 <LogIn className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </>
          )}
        </button>
